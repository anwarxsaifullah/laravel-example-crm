                ...
                <div class="max-w-xl">
                    <form method="post" action="{{ route('companies.update', $company->id) }}" class="mt-6 space-y-6" enctype="multipart/form-data">
                        ...
                        <div>
                            ...
                            <x-text-input id="name" name="name" type="text" class="mt-1 block w-full" required autofocus autocomplete="name" :value="old('name', $company->name)" />
                        ...
                        <div>
                            ...
                            <x-text-input id="website" name="website" type="text" class="mt-1 block w-full" required autocomplete="website" :value="old('website', $company->website)" />
